...
import {
  ...
  reservasTelaSearch,
  cancelarReserva
} from "../../graphql/reserva/reserva-json";
...
export class ReservaServiceProvider extends ConexaoProvider {
  ...
  async carregarReservaPorUsuario(id_usuario: number) {
    ...
    return await new Promise((resolve, reject) => {
      this.http
        .post(this.baseUri, minhasReservas(id_usuario), {
  ...
  async carregarReservasTelaHome(
    ...
    return await new Promise((resolve, reject) => {
      this.http
        .post(this.baseUri, reservasTelaHome(id_departamento, data, periodo), {
          headers: ConexaoProvider.headersToken
        })
        .subscribe((result: any) => {
          if (result.errors) {
  ...
  carregarReservaPorDataSala(data: string, id_dept: number, id_sala: number) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.http
        .get(
          this.baseUri +
            "reserva/buscaPorDepartamentoDataSala/?data=" +
            btoa(data + "") +
            "&id_departamento=" +
            btoa(id_dept + "") +
            "&id_sala=" +
  ...
  async carregarReservasTelaSearch(
    data: string,
    id_departamento: number,
    id_sala: number
  ) {
    ...
    return await new Promise((resolve, reject) => {
      this.http
        .post(
          this.baseUri,
          reservasTelaSearch(id_departamento, id_sala, data),
          { headers: ConexaoProvider.headersToken }
        )
        .subscribe((result: any) => {
          if (result.errors) {
  ...
  async validarReservaMesmoHorario(
    id_usuario: number,
    data: string,
    periodo: number
  ) {
    ...
    return await new Promise((resolve, reject) => {
      this.http
        .post(
          this.baseUri,
          validarReservaMesmoHorario(id_usuario, data, periodo),
          { headers: ConexaoProvider.headersToken }
        )
        .subscribe((result: any) => {
          if (result.errors) {
  ...
  async cadastrarReserva(reserva: ReservaGraphql) {
    ...
    return await new Promise((resolve, reject) => {
      this.http
        .post(this.baseUri, cadastrarReserva(reservaInput(reserva)), {
          headers: ConexaoProvider.headersToken
        })
        .subscribe((result: any) => {
          if (result.errors) {
  ...
  async cancelarReserva(reserva: ReservaGraphql) {
    ...
    return await new Promise((resolve, reject) => {
      this.http
        .post(this.baseUri, cancelarReserva(id), {
          headers: ConexaoProvider.headersToken
        })
        .subscribe((result: any) => {
          if (result.errors) {
