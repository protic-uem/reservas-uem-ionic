...
export class DisciplinaGraphql {
  ...
  constructor(id?: number, codigo?: number, nome?:string, periodo?: string, turma?: number,
    tipo?: string, status?: number, departamento?:DepartamentoGraphql, curso?:CursoGraphql,
    usuario?:UsuarioGraphql) {
        this.id = id;
        this.codigo = codigo;
