...
export class ReservaGraphql {
  ...
  public getPeriodo(): string {
    ...
    if (this.periodo == 1) return p.um;
    else if (this.periodo == 2) return p.dois;
    else if (this.periodo == 3) return p.tres;
    else if (this.periodo == 4) return p.quatro;
    else if (this.periodo == 5) return p.cinco;
    else if (this.periodo == 6) return p.seis;
    return "";
  }
}
